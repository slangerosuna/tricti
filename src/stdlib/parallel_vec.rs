...
pub extern "C" fn par_sum_i64(input: *const i64, len: u64, num_threads: u64) -> i64 {
    ...
    pool.install(|| input_slice.par_iter().sum())
}
...
pub extern "C" fn par_product_i64(input: *const i64, len: u64, num_threads: u64) -> i64 {
    ...
    pool.install(|| input_slice.par_iter().product())
}

#[no_mangle]
pub extern "C" fn par_min_i64(
    input: *const i64,
    len: u64,
    num_threads: u64,
    has_value: *mut u8,
    ...
    let result = pool.install(|| input_slice.par_iter().min());
...
pub extern "C" fn par_max_i64(
    ...
    let result = pool.install(|| input_slice.par_iter().max());
...
#[no_mangle]
pub extern "C" fn par_map_add_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    addend: i64,
...
#[no_mangle]
pub extern "C" fn par_map_mul_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    multiplier: i64,
...
#[no_mangle]
pub extern "C" fn par_map_square_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    num_threads: u64,
...
#[no_mangle]
pub extern "C" fn par_map_negate_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    num_threads: u64,
...
#[no_mangle]
pub extern "C" fn par_filter_positive_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    result_len: *mut u64,
...
#[no_mangle]
pub extern "C" fn par_filter_negative_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    result_len: *mut u64,
...
#[no_mangle]
pub extern "C" fn par_filter_even_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    result_len: *mut u64,
...
#[no_mangle]
pub extern "C" fn par_filter_odd_i64(
    input: *const i64,
    output: *mut i64,
    len: u64,
    result_len: *mut u64,
