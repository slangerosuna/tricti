...
The design was inspired by practical experience with **Gnu Octave** (array and SIMD semantics), **Axum** (asynchronous pipelines), **Rusqlite** (relational state management), and a custom **Bevy-inspired ECS**. Another key motivation was a personal interest in **learning compiler construction**.
